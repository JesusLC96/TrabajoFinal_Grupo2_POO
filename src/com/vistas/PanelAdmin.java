...
public class PanelAdmin {
    ...
    private List<CategoriaCurso> listaCursos = new ArrayList<>();
    ...
    public void listar(){
        ...
        tablaCursos.setRowSorter(tr);
            ...
            for (Linea d:listaLinea){
                ...
                for(CategoriaCurso c: d.getListaTodoslosCursos()){
    ...
    public List<CategoriaCurso> getListaCursos() {
        return listaCursos;
    }
}
